...
.prediction{{font-size:22px;font-weight:700;margin:4px 0}}.confidence{{color:#aaa}}.scores{{display:grid;gap:7px;margin:16px 0}}.score{{display:flex;justify-content:space-between;border-top:1px solid #292c35;padding:8px 0;font-size:13px}}.actions{{display:grid;gap:8px}}button{{background:#1b1e26;color:#eee;border:1px solid #30333d;border-radius:10px;padding:10px 12px;cursor:pointer;text-align:left}}button:hover,button:focus{{border-color:#777;outline:none}}button.active{{border-color:#eee}}kbd{{display:inline-block;min-width:22px;padding:2px 5px;border:1px solid #555;border-radius:5px;text-align:center;background:#111318}}.secondary{{display:flex;gap:8px;margin-top:12px}}.secondary button{{flex:1;text-align:center}}#status{{min-height:22px;margin-top:12px;color:#aaa}}.help{{font-size:12px;color:#777;margin-top:14px;line-height:1.5}}.done{{padding:40px;text-align:center}}a{{color:#aaa}}
...
<script id='candidate-data' type='application/json'>{payload}</script>
<script>
