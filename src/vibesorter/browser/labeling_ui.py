...
from ..vibes import CANONICAL_VIBES


def render_label_page(session: LabelSession) -> str:
    vibes = list(CANONICAL_VIBES)
    vibe_buttons = "".join(
