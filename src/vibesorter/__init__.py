...
__all__ = [
    ...
    "ATTRIBUTE_FAMILIES", "Brightness", "ClassificationMetrics", "Color",
    "ColorSample", "ConfidenceCalibrator", "ConfidenceObservation",
    "ImageFeatures", "ImageQuery", "LabelledImage", "LearnedClassifier",
